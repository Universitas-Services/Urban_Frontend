        ...
        <div className="flex-1 p-6">
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 flex flex-col gap-4">
                    ...
                    <h1 className="text-3xl font-extrabold text-heading-dark">Biblioteca GIRS</h1>
                    <div className="w-50 h-0.5 bg-heading-dark"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {/* Especial Promo Card */}
                    <div className="flex flex-col bg-heading-dark text-white rounded-xl shadow-sm border border-heading-dark overflow-hidden p-8 justify-between">
                        <div>
