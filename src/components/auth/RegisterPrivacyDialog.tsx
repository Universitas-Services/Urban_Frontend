...
import { REGISTER_PRIVACY } from './register-privacy.data';

type RegisterPrivacyDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
};

export function RegisterPrivacyDialog({ open, onOpenChange }: RegisterPrivacyDialogProps) {
    return (
