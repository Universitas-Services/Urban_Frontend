...
import { getUserByIdAction, deleteUserAction } from '@/lib/services/admin.service';
        ...
        <Sheet open={open} onOpenChange={handleOpenChange}>
            ...
            <SheetContent className="w-[400px] sm:w-[540px] overflow-y-auto">
                <SheetHeader>
                    ...
                    <SheetDescription>Información completa y acciones para el usuario seleccionado.</SheetDescription>
                </SheetHeader>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <Input value={profile?.nombreEnte || 'N/A'} readOnly className="bg-muted" />
                                    </div>
                                    <div className="space-y-1">
                                        <Label>Cargo</Label>
                                        ...
                                        <AlertDialogContent>
                                            <AlertDialogHeader>
                                                ...
                                                <AlertDialogDescription>
                                                    ...
                                                    <strong>{user.email}</strong> y todos sus datos asociados. Esta
