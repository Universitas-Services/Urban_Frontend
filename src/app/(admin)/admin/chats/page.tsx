...
import { getAdminChatConversationsAction } from '@/lib/services/admin-chat.service';
import { ChatConversation } from '@/types/admin-chat.types';
...
export default function ChatsPage() {
    ...
    useEffect(() => {
        const fetchConversations = async () => {
            try {
                const data = await getAdminChatConversationsAction(1, 10, searchQuery);
    ...
    return (
      ...
      */}
            ...
            >
                <ChatWindow key={selectedChat?.id} chat={selectedChat} onBack={() => setSelectedChatId(null)} />
            </main>
        </div>
    );
}
