...
export default function ChatDashboardPage() {
    ...
    const handleSendMessage = async (content: string) => {
        ...
        try {
            ...
            // Recargar lista de conversaciones para obtener el título real del backend
            if (isNew) {
    ...
    return (
        <div className="flex-1 overflow-auto custom-scrollbar p-6 bg-(--color-dashboard-bg) flex flex-col relative animate-fade-in">
            {/* Mobile Header */}
