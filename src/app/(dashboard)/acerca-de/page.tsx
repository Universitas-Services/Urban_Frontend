                ...
                <div className="w-full rounded-xl bg-white border border-gray-200/70 shadow-sm p-6 md:p-8 flex flex-col gap-6">
                    ...
                    <div className="space-y-4">
                        <p className="descripcion-cards leading-relaxed text-justify">
                            La Plataforma GIRS es una infraestructura jurídica y técnica especializada en Gestión
                            Integral de Residuos y Desechos Sólidos, desarrollada por Universitas Services, C.A. para
                            fortalecer el acceso a información normativa, técnica y documental vinculada al sector
                            ambiental y al aseo urbano en Venezuela.
                        </p>
                        <p className="descripcion-cards leading-relaxed text-justify">
                            La plataforma surge ante la necesidad de reducir la dispersión normativa y las dificultades
                            de acceso a información especializada que enfrentan municipios, operadores, asesores y
                            profesionales vinculados a la gestión de residuos sólidos. Su objetivo es facilitar procesos
                            de consulta, análisis y toma de decisiones mediante herramientas digitales diseñadas
                            específicamente para este sector.
                        </p>
                        <p className="descripcion-cards leading-relaxed text-justify">
                            La Biblioteca Legal GIRS reúne un repositorio especializado compuesto por leyes nacionales,
                            ordenanzas municipales, decretos tarifarios, sentencias del Tribunal Supremo de Justicia,
                            doctrina, planes de gestión y otros documentos técnicos relevantes. La información es
                            organizada, auditada y estructurada para facilitar su consulta y utilización dentro de un
                            mismo entorno digital.
                        </p>
                        <p className="descripcion-cards leading-relaxed text-justify">
                            Asimismo, la plataforma incorpora el Consultor IA – GIRS, un agente conversacional
                            especializado que opera utilizando exclusivamente la información contenida en la Biblioteca
                            Legal GIRS. Su finalidad es asistir al usuario en procesos de búsqueda, localización
                            normativa y análisis preliminar de información técnica y jurídica relacionada con la Gestión
                            Integral de Residuos Sólidos.
                        </p>
                        <p className="descripcion-cards leading-relaxed text-justify">
                            La Plataforma GIRS promueve además un modelo de colaboración institucional orientado a
                            fortalecer la construcción y actualización continua del repositorio documental,
                            especialmente mediante el intercambio de normativa municipal y criterios técnicos vinculados
                            al sector.
                        </p>
                        <p className="descripcion-cards leading-relaxed text-justify">
                            En Universitas creemos que una gestión moderna de residuos sólidos requiere acceso a
                            información confiable, organizada y técnicamente estructurada. Por ello, GIRS busca
                            contribuir al fortalecimiento de la seguridad jurídica, la sostenibilidad del aseo urbano y
                            el desarrollo de modelos de economía circular en Venezuela.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 overflow-y-auto pr-4 -mr-4 custom-scrollbar text-[15px] leading-relaxed text-neutral-dark/80 space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <p>
                                ...
                                subsanada.
                                <strong>Excepción:</strong> Las notificaciones formales de reclamos legales, disputas
                                por incumplimiento o terminación definitiva del contrato deberán canalizarse
